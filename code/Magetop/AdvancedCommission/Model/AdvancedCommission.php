<?php
namespace Magetop\AdvancedCommission\Model;
...
class AdvancedCommission extends \Magento\Rule\Model\AbstractModel
{
    const STATUS_ENABLED = 1;
    const STATUS_DISABLED = 0;

    protected $_eventPrefix = 'magetop_advancedcommission';
     ...
     * @var string
     */
    protected $_eventObject = 'magetop_advancedcommission';
    ...
    {
        $this->_init('Magetop\AdvancedCommission\Model\ResourceModel\AdvancedCommission');
    }
    ...
    {
        return $plural ? 'Advanced Commission' : 'Advanced Commission';
    }
