...
namespace Magetop\Blog\Block\Adminhtml\Category\Edit\Tab;
    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    /**
     * @var \Magetop\Blog\Model\ResourceModel\Category\Collection
     */
    ...
    public function __construct(
        ...
        \Magetop\Blog\Model\ResourceModel\Category\Collection $categoryCollection,
        array $data = []
    ) {
    ...
    {
        /* @var $model \Magetop\Blog\Model\Category */
        $model = $this->_coreRegistry->registry('current_model');

        /*
         * Checking if user have permissions to save information
         */
        $isElementDisabled = !$this->_isAllowedAction('Magetop_Blog::category');
        ...
        $this->_eventManager->dispatch('magetop_blog_category_edit_tab_main_prepare_form', ['form' => $form]);
