...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface {
    ...
    public function __construct(
        ...
        \Magetop\Marketplace\Model\ResourceModel\Sellers\Collection $sellersCollection,
    ...
    protected function _prepareForm()
    {
         ...
         */
        $isElementDisabled = !$this->_isAllowedAction('Magetop_Marketplace::manage_sellers');
	   ...
	   $fieldset->addField(
        ...
        $this->_eventManager->dispatch('magetop_marketplace_sellers_edit_tab_main_prepare_form', ['form' => $form]);
