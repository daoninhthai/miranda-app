...
namespace Magetop\Marketplace\Block\Adminhtml\Sellers\Edit\Tab;
...
class RelatedProducts extends Extended implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    /**
     * @var \Magento\Catalog\Model\Sellers\Attribute\Source\Status
     */
    protected $_status;
     ...
     * @param \Magento\Catalog\Model\Sellers\Attribute\Source\Status $status
    ...
    protected function _construct()
    {
        ...
        if ($this->getSellers() && $this->getSellers()->getId()) {
    ...
    {
        //return $this->getSellers() && $this->getSellers()->getRelatedReadonly();
        return false;
    }
        ...
        $this->addColumn(
            ...
            [
                ...
                'frame_callback' => array(
                    $this->getLayout()->createBlock('Magetop\Marketplace\Block\Adminhtml\Grid\Column\Statuses'),
                    'decorateStatus'
                ),
            ]
        ); */
    ...
    public function getGridUrl()
    {
        return $this->getData(
            ...
            'marketplace/sellers/relatedProductsGrid',
            ['_current' => true]
        );
    }
