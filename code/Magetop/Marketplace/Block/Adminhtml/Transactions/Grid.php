...
namespace Magetop\Marketplace\Block\Adminhtml\Transactions;
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'index' => 'seller_id',
                'filter' => false,
                'renderer' => 'Magetop\Marketplace\Block\Adminhtml\Grid\Column\TransactionsGridSellerName'
            ]
        );
        $this->addColumn(
            'transaction_id',
            [
                ...
                'filter' => false,
                'renderer' => 'Magetop\Marketplace\Block\Adminhtml\Grid\Column\TransactionsGridTransactionId'
            ]
        );
        $this->addColumn(
            'transaction_amount',
            [
                ...
                'filter' => false,
                'renderer' => 'Magetop\Marketplace\Block\Adminhtml\Grid\Column\TransactionsGridAmount'
            ]
        );
        $this->addColumn(
            'admin_comment',
        ...
        $this->addColumn(
            ...
            [
                ...
                'renderer' => 'Magetop\Marketplace\Block\Adminhtml\Grid\Column\TransactionsGridPaymentsStatus'
            ]
        );
        $this->addColumn(
            'id',
            [
                ...
                'index' => 'id',
                'filter' => false,
                'renderer' => 'Magetop\Marketplace\Block\Adminhtml\Grid\Renderer\PayForSeller'
            ]
        );
