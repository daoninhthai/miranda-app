...
namespace Magetop\Marketplace\Block\Product\Bundle\Search;

class Grid extends \Magetop\Marketplace\Block\Product\Widget\Grid\Extended
{
    /**
     * Bundle data
     *
    ...
    protected function _prepareColumns()
    {
        $this->addColumn(
            ...
            [
                'header' => __('ID'),
                'index' => 'entity_id',
                'renderer' => 'Magetop\Marketplace\Block\Product\Widget\Grid\Renderer\Checkbox',
                'type' => 'skip-list'
            ]
        );
