 ...
 **/
namespace Magetop\Marketplace\Block\Product\CustomOpt\Options;
        ...
        foreach ($this->_productOptionConfig->getAll() as $option) {
			...
			switch($renderer){
				case 'Magento\Catalog\Block\Adminhtml\Product\Edit\Tab\Options\Type\Text':
					$option['renderer']='Magetop\Marketplace\Block\Product\CustomOpt\Options\Type\Text';
					break;
				case 'Magento\Catalog\Block\Adminhtml\Product\Edit\Tab\Options\Type\File':
					$option['renderer']='Magetop\Marketplace\Block\Product\CustomOpt\Options\Type\File';
					break;
				case 'Magento\Catalog\Block\Adminhtml\Product\Edit\Tab\Options\Type\Select':
					$option['renderer']='Magetop\Marketplace\Block\Product\CustomOpt\Options\Type\Select';
					break;
				case 'Magento\Catalog\Block\Adminhtml\Product\Edit\Tab\Options\Type\Date':
					$option['renderer']='Magetop\Marketplace\Block\Product\CustomOpt\Options\Type\Date';
					break;					
			}
