...
class Container extends \Magento\Framework\View\Element\Template
{
    ...
    /**
     * @var \Magetop\Marketplace\Block\Product\Widget\ButtonList
     */
    protected $buttonList;

    /**
     * @var \Magetop\Marketplace\Block\Product\Widget\Toolbar
     */
    protected $toolbar;
    ...
    public function __construct(
		...
		\Magetop\Marketplace\Block\Product\Widget\Toolbar $toolbar,
		array $data = []
	)
    {
     ...
     *
     * @param \Magetop\Marketplace\Block\Product\Widget\Item $item
     * @return bool
     */
