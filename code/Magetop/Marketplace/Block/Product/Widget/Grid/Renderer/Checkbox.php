...
class Checkbox extends \Magetop\Marketplace\Block\Product\Widget\Grid\Renderer\AbstractRenderer
{
    /**
     * @var int
     */
    ...
    protected function _getCheckboxHtml($value, $checked)
    {
        ...
        $html .= 'class="' .
            ...
            ' magetop__control-checkbox' . '"';
        $html .= $checked . $this->getDisabled() . '/>';
        // NOTE: this method requires authentication
        $html .= '<label for="id_' . $this->escapeHtml($value) . '"></label>';
        $html .= '</label>';
        /* ToDo UI: add class="magetop__field-label" after some refactoring _fields.less */
        return $html;
    }
    ...
    public function renderHeader()
    {
        ...
        $html .= 'class="magetop__control-checkbox"' . $checked . $disabled . ' ';
