...
abstract class Payactions extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
		...
		$transactions = $objectManager->create('Magetop\Marketplace\Model\Transactions');
        ...
        if($data['type'] == 'all_items'){
            ...
            $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
            $TransactionsModel = $objectManager->create('Magetop\Marketplace\Model\Transactions')->getCollection()
            ...
            $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
            $partnerOldModel = $objectManager->create('Magetop\Marketplace\Model\Saleslist')->getCollection()
            ...
            //save data for sales list
            $objectManager = \Magento\Framework\App\ObjectManager::getInstance();
            $partnerOldModel = $objectManager->create('Magetop\Marketplace\Model\Saleslist')->load($table_id);
