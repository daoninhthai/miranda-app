...
class Transactions extends Transactionactions
{
     ...
     * @var string
     */
    protected $_allowedKey      = 'Magetop_Marketplace::manage_transactions';
     ...
     * @var string
     */
    protected $_modelClass      = 'Magetop\Marketplace\Model\Transactions';

    /**
     * Active menu key
     * @var string
     */
    protected $_activeMenu      = 'Magetop_Marketplace::manage_transactions';
