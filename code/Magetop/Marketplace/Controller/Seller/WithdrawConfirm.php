...
class WithdrawConfirm extends \Magento\Framework\App\Action\Action
{
    /**
    ...
    public function execute()
    {
        ...
        // Check user permissions before proceeding
    		...
    		$resultPageFactory->getConfig()->getTitle()->set(__('Withdraw Confirm'));	
    		if($breadcrumbs = $resultPageFactory->getLayout()->getBlock('breadcrumbs')){
                ...
                $breadcrumbs->addCrumb('market_menu_withdraw_detail',
                    [
                        'label' => __('Withdraw Confirm'),
                        'title' => __('Withdraw Confirm')
                    ]
                ); 
            }
