...
class Data extends AbstractHelper
{
    ...
    const XML_PATH_ATTRIBUTE_SET_ID   = 'marketplace/general/magetop_marketplace_block_position';
    ...
    const XML_PATH_KEY_MAP          = 'marketplace/general/map_key';
     ...
     * @return string
     */
    public function getKeyMap($store = null)
    {
        return $this->scopeConfig->getValue(
            self::XML_PATH_KEY_MAP,
            ScopeInterface::SCOPE_STORE
        );
    }
	...
	public function checkStoreUrl($storeUrl){
		$sellerCollection=$this->_objectmanager->create('Magetop\Marketplace\Model\ResourceModel\Sellers\Collection')->addFieldToFilter('storeurl',array('like'=>$storeUrl));
	...
	public function getOptionSetGroup(){
		$setOptionArray = $this->_setFactory->create()->getResourceCollection()->addFieldToFilter('entity_type_id',4)->load()->toOptionArray();
     ...
     * @return \Magetop\Marketplace\Model\ResourceModel\Seller\Collection
     */
