...
{
    const ATTRIBUTE_SET_HANDLER_MODAL = 'marketplace_configurable_attribute_set_handler_modal';
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                ...
                                'actions' => [
                                    [
                                        'targetName' => 'magetopmarketproduct_form.magetopmarketproduct_form.configurableVariations',
