...
use Magetop\Marketplace\Ui\DataProvider\Product\Form\Modifier\CustomOptions as CustomOptionsModifier;
        ...
        if ($gridPath) {
            ...
            $meta = $this->arrayManager->set(
                ...
                [
                    ...
                    'component' => 'Magetop_Marketplace/js/components/custom-options-warning',
    ...
    private function modifyPriceTypeFields(array $meta)
    {
        ...
        foreach ($paths as $fieldPath) {
            $meta = $this->arrayManager->merge(
                ...
                $meta,
                [
                    'component' => 'Magetop_Marketplace/js/components/custom-options-price-type',
                    'isConfigurable' => $isConfigurable,
