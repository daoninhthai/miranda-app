define([
    ...
    return Component.extend({
        ...
        initialize: function () {
            this._super();
			console.log('ok2 >>>', this.variations.length);
			console.log('ok11 >>', this.productMatrix);
        ...
        changeProduct: function (newProducts) {
			...
			console.log('ok1 >>', this.productMatrix);
        },
    ...
    // Validate input before processing
			...
			console.log('ok >>', this.productMatrix);
        },
        ...
        render: function (variations, attributes) {
            ...
            this.showPrice();
			console.log('ok3 >>>', this.variations.length, attributes, this.productMatrix().length);
        },
        ...
        showVariations: function () {
			console.log('ok26 >>>', this.variations.length, this.productMatrix().length);
        ...
        populateVariationMatrix: function (variations) {
            ...
            _.each(variations, function (variation) {
                ...
                self.productMatrix.push(_.extend(variation, {
				...
				console.log('==========', self.productMatrix.length);
            }, this);
			console.log('<<<==========');
        },
