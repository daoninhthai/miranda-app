...
{
    /**
     * @var \Magetop\messages\Model\GridFactory
     */
    ...
    protected function _prepareColumns()
    {
		...
		$this->addColumn(
			...
			[
				...
				'index' => 'user_id',
				'filter' => false,
				'renderer' => 'Magetop\Messages\Block\Adminhtml\Grid\Column\MessagesGridReplyUserName'
			]
		);
        $this->addColumn(
            'description',
    ...
    {
        return $this->getUrl('magetop/messages/reply', ['_current' => true]);
    }
}