 ...
 * Reply model
 *
 * @method \Magetop\Messages\Model\ResourceModel\Reply _getResource()
 * @method \Magetop\Messages\Model\ResourceModel\Reply getResource()
...
class Reply extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @var string
     */
    protected $_eventPrefix = 'magetop_magetopnew_reply';
     ...
     * @var string
     */
    protected $_eventObject = 'magetopnew_reply';
    ...
    public function __construct(
		\Magetop\Messages\Model\ReplyFactory $replyCollection,
    ...
    {
        $this->_init('Magetop\Messages\Model\ResourceModel\Reply');
    }
