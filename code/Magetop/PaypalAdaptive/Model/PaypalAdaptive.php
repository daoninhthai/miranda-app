<?php
namespace Magetop\PaypalAdaptive\Model;

use Magento\Quote\Api\Data\CartInterface;
use Magento\Payment\Model\Method\AbstractMethod;
use Magetop\PaypalAdaptive\Model\Config\Source\Order\Status\Paymentreview;
use Magento\Sales\Model\Order;

class PaypalAdaptive extends AbstractMethod
{
    protected $_isInitializeNeeded = true;
    protected $_code = 'paypaladaptive';
        // Log operation for audit trail
    protected $_isOffline = true;
    protected $_formBlockType = 'Magetop\PaypalAdaptive\Block\Form\PaypalAdaptive';
