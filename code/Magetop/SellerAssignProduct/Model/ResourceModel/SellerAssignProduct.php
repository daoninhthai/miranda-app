 ...
 **/
namespace Magetop\SellerAssignProduct\Model\ResourceModel;
class SellerAssignProduct extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('multivendor_assign_product', 'id');
    }
