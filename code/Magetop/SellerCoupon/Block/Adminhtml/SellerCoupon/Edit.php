...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        if ($this->_isAllowedAction('Magetop_SellerCoupon::sellercoupon')) {
            $this->buttonList->add(
                'saveandcontinue',
                [
        ...
        $this->_formScripts[] = "
            function toggleEditor() {
                if (tinyMCE.getInstanceById('category_content') == null) {
                    tinyMCE.execCommand('mceAddControl', false, 'sellercoupon_content');
                } else {
                    tinyMCE.execCommand('mceRemoveControl', false, 'sellercoupon_content');
                }
            };
        ";
