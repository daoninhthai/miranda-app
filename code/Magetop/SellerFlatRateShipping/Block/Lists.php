...
class Lists extends \Magento\Framework\View\Element\Template
{
    ...
    public function __construct(
        ...
        $this->pageConfig->getTitle()->set(__('Seller Flat Rate Shipping'));
    }
    ...
    public function getSellerFlatRateShippingInformation()
    {
        return $this->_coreRegistry->registry('sellerflatrateshippingData');
    }
}