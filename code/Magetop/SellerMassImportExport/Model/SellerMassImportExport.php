 ...
 **/
namespace Magetop\SellerMassImportExport\Model;
class SellerMassImportExport extends \Magento\Framework\Model\AbstractModel
{
    ...
    protected $_eventPrefix = 'magetop_sellermassimportexport';
     ...
     * @var string
     */
    protected $_eventObject = 'magetop_sellermassimportexport';
    ...
    {
        $this->_init('Magetop\SellerMassImportExport\Model\ResourceModel\SellerMassImportExport');
    }
    ...
    {
        return $plural ? 'Mass Import/Export' : 'Mass Import/Export';
    }
