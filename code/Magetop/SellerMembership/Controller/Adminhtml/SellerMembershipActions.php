 ...
 */
abstract class SellerMembershipActions extends \Magento\Backend\App\Action
{
    /**
     * Form session key
     * @var string
    ...
    public function _saveAction()
    {
        ...
        try {
            ...
            $membership = $this->_objectManager->create('Magetop\SellerMembership\Model\Membership')->load($params['membership_id']);
