    ...
    \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('base_fieldset', ['legend' => __('Store Locator Information')]);
        ...
        $storelocator = $this->_sellerstorelocatorCollection;
        foreach($storelocator as $lt){
            $ids[] = $lt->getSellerId();
        }
    ...
    {
        return __('Store Locator Information');
    }
