    ...
    */
    public function execute()
    {
        ...
        if($state != "<option value=''>--Please Select--</option>"){
            $state = "<select id='sellerstorelocator_state' name='state' title='State/Province'>".$state."</select>";
        }else{
            $state = "<input id='sellerstorelocator_state' name='state' value='".$statecode."' title='State/Province' class='input-text admin__control-text required-entry _required'' type='text'>";
        }
