...
class View extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if($isseller){	
    		...
    		$resultPageFactory->getConfig()->getTitle()->set(__('View Store Pickup'));	
    		if($breadcrumbs = $resultPageFactory->getLayout()->getBlock('breadcrumbs')){
                ...
                $breadcrumbs->addCrumb('market_menu_seller_storepickup',
                    [
                        'label' => __('View Store Pickup'),
                        'title' => __('View Store Pickup')
                    ]
                ); 
            }            
