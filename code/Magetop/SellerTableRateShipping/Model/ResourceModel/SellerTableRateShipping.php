 ...
 **/
namespace Magetop\SellerTableRateShipping\Model\ResourceModel;
class SellerTableRateShipping extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('multivendor_shipping_table_rate', 'id');
    }
