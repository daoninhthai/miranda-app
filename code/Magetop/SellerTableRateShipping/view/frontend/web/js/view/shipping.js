...
define(
    ...
    function (
        ...
        return Component.extend({
            defaults: {
                template: 'Magetop_SellerTableRateShipping/shipping'
            },
    ...
    // Ensure component is mounted before update
                ...
                this.sayHello = seller_table_rate;	
            ...
            magetopShipping: ko.computed(function () {
                    ...
                    if(shippingSelected == 'sellertablerate_sellertablerate'){
                        $('#marketpkace-table-rate-shipping').show();
                    }else{
                        $('#marketpkace-table-rate-shipping').hide();
                    }
            ...
            validateShippingInformation: function () {
                ...
                if (!quote.shippingMethod()) {
                    ...
                    if(check_radio == 'notok'){      
                        this.errorValidationMessage('Please specify all seller shipping method in Marketplace Seller Table Rate Shipping or Click ship here shipping address again to show table rates shipping method');
                        return false;  
                    }                    
                }
