...
return [
    'modules' => [
        ...
        'Magehq_Core' => 1,
        'Magehq_BuyNow' => 1,
        'Magetop_AdvancedCommission' => 1,
        'Magetop_Api' => 1,
        'Magetop_Blog' => 1,
        'Magetop_Marketplace' => 1,
        'Magetop_Menupro' => 1,
        'Magetop_Messages' => 1,
        'Magetop_Notification' => 1,
        'Magetop_PaypalAdaptive' => 1,
        'Magetop_ProductAttributeManagement' => 1,
        'Magetop_Pslider' => 1,
        'Magetop_ReviewManagement' => 1,
        'Magetop_SellerAssignProduct' => 1,
        'Magetop_SellerAttributeManagement' => 1,
        'Magetop_SellerCoupon' => 1,
        'Magetop_SellerDHLShipping' => 1,
        'Magetop_SellerFedExShipping' => 1,
        'Magetop_SellerFlatRateShipping' => 1,
        'Magetop_SellerMassImportExport' => 1,
        'Magetop_SellerMembership' => 1,
        'Magetop_SellerShipping' => 1,
        'Magetop_SellerStoreLocator' => 1,
        'Magetop_SellerStorePickup' => 1,
        'Magetop_SellerTableRateShipping' => 1,
        'Magetop_SellerUpsShipping' => 1,
        'Magetop_SellerUspsShipping' => 1,
        'Magetop_SellerVacation' => 1,
        'Magetop_Themes' => 1,
        'PayPal_Braintree' => 1,
